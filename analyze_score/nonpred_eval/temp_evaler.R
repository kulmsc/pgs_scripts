...
final_ans <- readRDS(paste0("per_score_results/", tolower(author), ".res.RDS"))
final_ans[[2]] <- return_pheno_defs

saveRDS(final_ans, paste0("per_score_results/", tolower(author), ".res.RDS"))

...
ethnic_scores$ethnic[ethnic_score_eids[,1] %in% asian_fam[,1]] <- "asian"
ethnic_scores$ethnic[ethnic_score_eids[,1] %in% african_fam[,1]] <- "african"
ethnic_scores$ethnic[ethnic_score_eids[,1] %in% euro_fam[,1]] <- "euro"

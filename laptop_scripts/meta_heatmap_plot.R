...
method_names <- c("sampe_size", "cases", "cases/controls", "snps", "h2", "uk_snps", "uk_case/uk_control", "uk_case")
...
corr_plot <- ggplot(p_vals, aes(x, y, fill = -log10(value))) + geom_raster() +
...
ggsave("reg_plots/pval_heatmap_plot.png", corr_plot, "png", width = 5, height = 5)
ggsave("reg_plots/heatmap_plot.png", heatmap_plot, "png", width = 5, height = 5)
